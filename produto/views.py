...
class AdicionarAoCarrinho(View):
    def get(self, *args, **kwargs):
        ...
        self.request.session.save()
        messages.success(
            self.request, f'Produto {produto_nome} {variacao_nome} adicionado ao seu carrinho {carrinho[variacao_id]["quantidade"]}x.')
        return redirect(http_referer)
...
class RemoverDoCarrinho(View):
    def get(self, *args, **kwargs):
        ...
        messages.success(
            self.request, f'Produto {carrinho["produto_nome"]} {carrinho["variacao_nome"]} removido do seu varrinho.')
